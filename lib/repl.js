...
export default class REPL {
    ...
    constructor(consoleView) {
        ...
        atom.commands.add('atom-text-editor', {
            'tidalcycles-dsm0-fork:eval': () => this.eval(CONST_LINE, false),
            'tidalcycles-dsm0-fork:eval-multi-line': () => this.eval(CONST_MULTI_LINE, false),
            'tidalcycles-dsm0-fork:eval-copy': () => this.eval(CONST_LINE, true),
            'tidalcycles-dsm0-fork:eval-multi-line-copy': () => this.eval(CONST_MULTI_LINE, true),
            'tidalcycles-dsm0-fork:hush': () => this.hush()
        });
